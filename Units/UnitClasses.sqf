/*
 * Description: This file contains vehicle types and unit types for most units spawned in the mission.
...
a3e_arr_PrisonBackpackWeapons = [
	...
	["rhs_weap_makarov_pmm","rhs_mag_9x18_12_57N181S"],
...
a3e_arr_AmmoDepotBasicWeapons = [
	["rhs_weap_pya", 50, 2, 5, ["rhs_mag_9x19_17"], 6],
	["SMG_02_F", 10, 1, 2, ["30Rnd_9x21_Mag"], 6],
	["rhs_weap_ak74m_dtk", 100, 3, 5, ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], 6],
	["rhs_weap_ak74m_2mag_dtk", 50, 2, 4, ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green"], 4],
	["rhs_weap_ak74m_gp25_dtk", 75, 2, 4, ["rhs_30Rnd_545x39_AK", "rhs_30Rnd_545x39_AK_green", "rhs_VOG25"], 4],
	["rhs_weap_pkp_pkas", 20, 1, 2, ["rhs_100Rnd_762x54mmR"], 4],
	["rhs_weap_svdp_npz", 10, 1, 2, ["rhs_10Rnd_762x54mmR_7N1"], 6],
	["rhs_weap_svd_pso1", 10, 1, 2, ["rhs_10Rnd_762x54mmR_7N1"], 6],
	["rhs_weap_makarov_pmm", 50, 2, 4, ["rhs_mag_9x18_12_57N181S"], 4],
	["rhs_weap_akm", 50, 1, 3, ["rhs_30Rnd_762x39mm"], 6],
	["rhs_weap_akm_gp25", 50, 1, 3, ["rhs_30Rnd_762x39mm","rhs_VOG25"], 4],
	["rhs_weap_ak103_dtk", 30, 1, 2, ["rhs_30Rnd_762x39mm_tracer"], 6],
	["rhs_weap_m14ebrri_leu", 10, 1, 2, ["rhsusf_20Rnd_762x51_m118_special_Mag"], 6],
	["rhs_weap_m4", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 4],
	["rhs_m4a1_m320", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag", "rhs_mag_M433_HEDP", "rhs_mag_M714_white","rhs_mag_M661_green"], 4],
	["rhs_weap_m4_grip", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 4],
	["rhs_weap_m4a1", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 4],
	["rhs_weap_sr25", 10, 1, 2, ["rhsusf_20Rnd_762x51_m118_special_Mag"], 6],
	["rhs_weap_m16a4", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 6],
	["rhs_weap_m4a1_carryhandle_pmag", 10, 1, 2, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 6]
];

// Weapons and ammo in the special weapons box
a3e_arr_AmmoDepotSpecialWeapons = [
	["rhs_weap_svdp_wd_npz", 50, 2, 4, ["rhs_10Rnd_762x54mmR_7N1"], 9],
	["rhs_weap_svds_pso1", 50, 2, 4, ["rhs_10Rnd_762x54mmR_7N1"], 9],
...
a3e_arr_AmmoDepotLaunchers = [
	["rhs_weap_rpg7", 50, 1, 2, ["rhs_rpg7_PG7VL_mag", "rhs_rpg7_PG7VR_mag", "rhs_rpg7_OG7V_mag", "rhs_rpg7_TBG7V_mag"], 6],
	["rhs_weap_rpg26", 50, 1, 3, ["rhs_rpg26_mag"], 3],
	["rhs_weap_rshg2", 50, 1, 3, ["rhs_rshg2_mag"], 3],
	["rhs_weap_igla", 50, 1, 2, ["rhs_mag_9k38_rocket"], 3],
	["rhs_weap_fgm148", 10, 1, 2, ["rhs_fgm148_magazine_AT"], 2]
	//, ["launch_I_Titan_F", 100, 1, 1, ["Titan_AA"], 3],
	//["launch_I_Titan_short_F", 100, 1, 1, ["Titan_AP", "Titan_AT"], 3],
	//["launch_B_Titan_F", 100, 1, 1, ["Titan_AA"], 3],
	//["launch_B_Titan_short_F", 100, 1, 1, ["Titan_AP", "Titan_AT"], 3]
];
...
a3e_arr_AmmoDepotVehicle = [
	...
	[objNull, 10, 1, 1, ["rhs_mag_M433_HEDP", "rhs_mag_M714_white", "rhs_mag_M716_yellow", "rhs_mag_M713_red", "rhs_mag_M585_white", "rhs_mag_M661_green"], 5],
	[objNull, 50, 1, 1, ["rhs_VOG25"], 25],
	[objNull, 50, 1, 1, ["FlareWhite_F", "FlareGreen_F", "FlareRed_F", "FlareYellow_F"], 25],
	[objNull, 50, 1, 1, ["UGL_FlareWhite_F", "UGL_FlareGreen_F", "UGL_FlareRed_F", "UGL_FlareYellow_F", "UGL_FlareCIR_F"], 25],
	[objNull, 50, 1, 1, ["rhs_mag_zarya2"], 25],
	[objNull, 50, 1, 1, ["1Rnd_HE_Grenade_shell", "3Rnd_HE_Grenade_shell"], 25]
];
...
a3e_arr_AmmoDepotItems = [
	["Laserdesignator", 10, 1, 2],
	["Rangefinder", 10, 1, 2],
	["lerca_1200_black", 10, 1, 2],
	["Leupold_Mk4", 10, 1, 2],
	["Binocular", 50, 2, 3, [], 0],
	["ItemCompass", 50, 1, 3],
	["ItemGPS", 10, 1, 2],
	...
	["rhs_acc_tgpa", 10, 1, 3],
	["rhs_acc_tgpv", 10, 1, 3],
	["rhs_acc_muzzleFlash_dtk", 10, 1, 3],
	["rhs_acc_dtk3", 10, 1, 3],
	["rhs_acc_dtk1", 10, 1, 3],
	["rhs_acc_pgo7v", 10, 1, 3],
	["rhs_acc_1p63", 10, 1, 3],
	["rhs_acc_pkas", 20, 1, 3],
	["rhs_acc_ekp1", 20, 1, 3],
	["rhs_acc_ekp1b", 20, 1, 3],
	["rhs_acc_ekp1c", 20, 1, 3],
	["rhs_acc_ekp1d", 20, 1, 3],
	["rhs_acc_pso1m2", 20, 1, 3],
	["rhs_acc_1p29", 20, 1, 3],
	["rhs_acc_1p78", 10, 1, 3],
	["rhsusf_acc_EOTECH", 10, 1, 3],
	["rhsusf_acc_SF3P556", 10, 1, 3],
	["rhsusf_acc_SFMB556", 10, 1, 3],
	["rhsusf_acc_rotex5_grey", 10, 1, 3],
	["rhsusf_acc_HAMR", 10, 1, 3],
	["rhsusf_acc_LEUPOLDMK4", 10, 1, 3],
	["rhsusf_acc_ELCAN", 10, 1, 3],
	["rhsusf_acc_ACOG", 10, 1, 3],
	["rhsusf_acc_ACOG2", 10, 1, 3],
	["rhsusf_acc_M2010S", 10, 1, 3],
	["rhsusf_acc_SR25S", 10, 1, 3],
	["rhsusf_acc_compm4", 10, 1, 3],
	["rhsusf_acc_eotech_552", 10, 1, 3],
	["rhsusf_acc_ACOG3", 10, 1, 3],
	["O_UavTerminal", 10, 1, 3],
	["optic_DMS", 10, 1, 3],
	["optic_Yorris", 10, 1, 3],
	["optic_LRPS", 10, 1, 3],
	["optic_AMS", 10, 1, 2],
	["optic_KHS_blk", 10, 1, 2],
	["bipod_01_F_blk", 10, 1, 2],
	["bipod_02_F_blk", 10, 1, 2],
	["bipod_03_F_blk", 10, 1, 2],
	["bipod_01_F_mtp", 10, 1, 2],
	["bipod_02_F_hex", 10, 1, 2],
	["bipod_03_F_oli", 10, 1, 2],
	["rhs_bipod", 20, 1, 2],
	["rhsusf_acc_harris_bipod", 10, 1, 2]
];
if(Param_NoNightvision==0) then {
	a3e_arr_AmmoDepotItems = a3e_arr_AmmoDepotItems + [
		["NVGoggles", 10, 1, 3],
		["rhs_acc_1pn93_1", 10, 1, 3],
		["rhs_acc_1pn93_2", 10, 1, 3],
		["optic_Nightstalker", 10, 1, 3]
	];
};
...
a3e_arr_CivilianCarWeapons = [
	["rhs_weap_makarov_pmm", "rhs_mag_9x18_12_57N181S", 5],
	["rhs_weap_ak74m_2mag_npz_dtk", "rhs_30Rnd_545x39_AK", 5],
	["rhs_weap_M590_5RD", "rhsusf_5Rnd_00Buck", 11],
	["rhs_weap_M590_8RD", "rhsusf_8Rnd_00Buck", 9],
	["rhs_weap_mk18_grip2_eotech_usmc", "rhs_mag_30Rnd_556x45_Mk318_Stanag", 9],
	["rhs_weap_m4a1_blockII_grip2_acog2_usmc", "rhs_mag_30Rnd_556x45_Mk318_Stanag", 8],
	["rhs_weap_M320", "rhs_mag_M433_HEDP", 10],
	["rhs_weap_ak74m_npz_dtk", "rhs_30Rnd_545x39_AK", 7],
	["rhs_weap_m240b_usmc", "rhsusf_100Rnd_762x51", 5],
	["rhs_weap_m16a4_grip_acog_usmc", "rhs_mag_30Rnd_556x45_Mk318_Stanag", 8],
	["rhs_weap_XM2010_wd_leu", "rhsusf_5Rnd_300winmag_xm2010", 10],
	["rhs_weap_sr25_sup_marsoc", "rhsusf_20Rnd_762x51_m118_special_Mag", 12],
	["rhs_weap_rshg2","rhs_rshg2_mag", 2],
	["MineDetector", objNull, 0],
//	["Medikit", objNull, 0],
//	["Toolkit", objNull, 0],
	["Binocular", objNull, 0],
	[objNull, "SatchelCharge_Remote_Mag", 2],
...
a3e_arr_CrashSiteWeapons = [
	["rhs_m4a1_m320", 50, 2, 5, ["rhs_mag_30Rnd_556x45_M855A1_Stanag","rhs_mag_M433_HEDP"], 6],
	["rhs_weap_M136_hp", 10, 1, 2, ["rhs_m136_hp_mag"], 1],
	["rhs_weap_m16a4_grip", 100, 3, 5, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 6],
	["rhs_weap_M320", 10, 1, 2, ["rhs_mag_M433_HEDP","rhs_mag_m576","rhs_mag_M661_green"], 6],
	["rhs_weap_m4_grip2", 75, 2, 4, ["rhs_mag_30Rnd_556x45_M855A1_Stanag"], 4],
	["rhs_weap_m14ebrri", 20, 1, 2, ["rhsusf_20Rnd_762x51_m118_special_Mag"], 8],
	["rhs_weap_XM2010_wd", 10, 1, 2, ["rhsusf_5Rnd_300winmag_xm2010"], 8],
	["rhs_weap_m240B", 10, 1, 2, ["rhsusf_100Rnd_762x51"], 6]
];
...
a3e_arr_CrashSiteItems = [
	["rhsusf_acc_M2010S", 10, 1, 3],
	["rhsusf_acc_rotex5_grey", 10, 1, 3],
	["rhsusf_acc_anpeq15_light", 10, 1, 3],
	["rhsusf_acc_eotech_552", 10, 1, 3],
	["rhsusf_acc_LEUPOLDMK4_2", 10, 1, 3],
	["rhsusf_acc_ACOG2", 10, 1, 3],
	["rhsusf_acc_harris_bipod", 10, 1, 3]
];
