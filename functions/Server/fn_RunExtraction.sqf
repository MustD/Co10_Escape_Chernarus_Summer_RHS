...
_result = [[((getMarkerPos _spawnMarkerName) select 0) + 25, ((getMarkerPos _spawnMarkerName) select 1) + 20, 100], 0, (a3e_arr_extraction_chopper call BIS_fnc_selectRandom), A3E_VAR_Side_Blufor] call BIS_fnc_spawnVehicle;
...
_result = [[((getMarkerPos _spawnMarkerName) select 0) - 40, ((getMarkerPos _spawnMarkerName) select 1) - 40, 100], 0, (a3e_arr_extraction_chopper_escort call BIS_fnc_selectRandom), A3E_VAR_Side_Blufor] call BIS_fnc_spawnVehicle;
