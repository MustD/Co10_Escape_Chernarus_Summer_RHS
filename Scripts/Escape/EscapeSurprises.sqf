            ...
            if (call _condition) then {
                ...
                if (_surpriseID == "DROPCHOPPER") then {
                    ...
                    for [{_i = 0}, {_i < _noOfDropUnits}, {_i = _i + 1}] do {
                        _soldierType = A3E_arr_recon_InfantryTypes call BIS_fnc_selectRandom;
                    ...
                    _helitype = a3e_arr_O_transport_heli call BIS_fnc_selectRandom;
					_crewtype = a3e_arr_O_pilots call BIS_fnc_selectRandom;
				...
				if (_surpriseID == "DROPCHOPPER_I") then {
                    ...
                    for [{_i = 0}, {_i < _noOfDropUnits}, {_i = _i + 1}] do {
                        _soldierType = a3e_arr_Escape_InfantryTypes_Ind call BIS_fnc_selectRandom;
                        _soldier = _dropGroup createUnit [_soldierType, [0,0,30], [], 0, "FORM"];
                        //_soldier setSkill (_minEnemySkill + random (_maxEnemySkill - _minEnemySkill));
						//[_soldier, a3e_var_Escape_enemyMinSkill] call EGG_EVO_skill;
                        _soldier setRank "CAPTAIN";
                    ...
                    _helitype = a3e_arr_I_transport_heli call BIS_fnc_selectRandom;
					_crewtype = a3e_arr_I_pilots call BIS_fnc_selectRandom;
                ...
                if (_surpriseID == "RUSSIANSEARCHCHOPPER") then {
                    ...
                    _helitype = a3e_arr_O_attack_heli call BIS_fnc_selectRandom;
					_crewtype = a3e_arr_O_pilots call BIS_fnc_selectRandom;
				...
				if (_surpriseID == "SEARCHDRONE") then {
					...
					_arr = [(getMarkerPos "drn_russianSearchChopperStartPosMarker"), 0, (a3e_arr_searchdrone call BIS_fnc_selectRandom), A3E_VAR_Side_Ind] call bis_fnc_spawnvehicle;
